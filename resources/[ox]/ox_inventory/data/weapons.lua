return {
	...
	Components = {
		...
		['at_suppressor_heavy2'] = {
			label = 'Tactical Suppressor Large',
			weight = 280,
			type = 'muzzle',
			client = {
		...
		['at_barrel'] = {
			...
			weight = 280,
			client = {
				component = {`COMPONENT_AT_SR_BARREL_01`,`COMPONENT_AT_MRFL_BARREL_02`,`COMPONENT_AT_MG_BARREL_02`,`COMPONENT_AT_SC_BARREL_02`, `COMPONENT_AT_CR_BARREL_02`},
				usetime = 2500
			}
		},

		['at_barrel2'] = {
			label = 'Heavy Barrel II',
			type = 'barrel',
			weight = 280,
			client = {
		...
		['at_scope_small'] = {
			...
			weight = 280,
			client = {
				component = {`COMPONENT_AT_SIGHTS`, `COMPONENT_AT_SCOPE_MACRO`, `COMPONENT_AT_SCOPE_MACRO_02`, `COMPONENT_AT_SCOPE_MACRO_02_MK2`, `COMPONENT_AT_SCOPE_MACRO`, `COMPONENT_AT_SCOPE_SMALL`, `COMPONENT_AT_SCOPE_SMALL_02`, `COMPONENT_AT_SCOPE_MACRO_MK2`},
				usetime = 2500
			}
		},
		...
		['at_scope_medium'] = {
			...
			weight = 280,
			client = {
				component = {`COMPONENT_AT_SCOPE_MEDIUM`, `COMPONENT_AT_SCOPE_MEDIUM_MK2`, `COMPONENT_AT_PI_RAIL`},
				usetime = 2500
			}
		},

		['at_scope_medium2'] = {
			label = 'Medium Scope II',
			type = 'sight',
			weight = 280,
			client = {
		...
		['at_skin_skull'] = {
			...
			weight = 50,
			client = {
				component = {`COMPONENT_MARKSMANRIFLE_MK2_CAMO_04`, `COMPONENT_COMBATMG_MK2_CAMO_04`, `COMPONENT_ASSAULTRIFLE_MK2_CAMO_04`, `COMPONENT_CARBINERIFLE_MK2_CAMO_04`, `COMPONENT_SPECIALCARBINE_MK2_CAMO_04`, `COMPONENT_PISTOL_MK2_CAMO_04`, `COMPONENT_REVOLVER_MK2_CAMO_04`},
				usetime = 2500
			}
		},
		...
		['at_clip_tcr_bpmk2'] = {
			label = 'Bullpup Rifle Mk II Tracer Rounds',
			type = 'magazine',
			weight = 50,
			client = {
		...
		['at_skin_skull_bpmk2'] = {
			label = 'Bullpup Rifle Mk II Skull Weapon Kit',
			type = 'skin',
			weight = 50,
			client = {
		...
		['at_clip_exv_pump2'] = {
			label = 'Pump Shotgun Mk II Explosive Slugs',
			type = 'magazine',
			weight = 50,
			client = {
				component = {`COMPONENT_PUMPSHOTGUN_MK2_CLIP_EXPLOSIVE`},
				usetime = 2500
			}
		},

		['at_skin_skull_psmk2'] = {
			label = 'Pump Shotgun Mk II Skull Weapon Kit',
			type = 'skin',
			weight = 50,
			client = {
		...
		['at_clip_inc_snipmk2'] = {
			label = 'Heavy Sniper Mk II Incendiary Rounds',
			type = 'magazine',
			weight = 50,
			client = {
		...
		['at_skin_skull_hsmk2'] = {
			label = 'Heavy Sniper Mk II Skull Weapon Kit',
			type = 'skin',
			weight = 50,
			client = {
		...
		['at_clip_tcr_sns2'] = {
			label = 'SNS Pistol Mk II Tracer Rounds',
			type = 'magazine',
			weight = 50,
			client = {
		...
		['at_flashlight_sns_mk2'] = {
			label = 'SNS Pistol Mk II Flashlight',
			type = 'flashlight',
			weight = 50,
			client = {
		...
		['at_skin_skull_snsmk2'] = {
			label = 'SNS Pistol Mk II Skull Weapon Kit',
			type = 'skin',
			weight = 50,
			client = {
		...
		['at_skin_skull2_snsmk2'] = {
			label = 'SNS Pistol Mk II Skull2 Weapon Kit',
			type = 'skin2',
			weight = 50,
			client = {
