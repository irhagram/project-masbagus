...
CreateThread(function()
    while true do
        ...
        if stalled and isPedDrivingAVehicle() then
            ...
            exports['alan-tasknotify']:SendAlert('error','Your vehicle has stalled',2500)
            local unstall = exports["reload-skillbar"]:taskBar(1500,math.random(2,5))
			...
			if GetPedInVehicleSeat(vehicle, -1) == ped then
				...
				exports['alan-tasknotify']:SendAlert('success','You managed to start your vehicle',2500)
			end
        end 
    end 
end)
