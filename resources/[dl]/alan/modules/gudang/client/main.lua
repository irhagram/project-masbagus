...
AddEventHandler('dl-gudang:MenuGudang', function(k, gudang)
    ESX.TriggerServerCallback('dl-gudang:checkGudang', function(gudang)
        if gudang then
            ...
            exports['alan-tasknotify']:SendAlert('error', 'Sewa dulu di gedung pemerintah')
        end
    end, infoGudang)
end)
...
AddEventHandler('dl-gudang:sewaKota', function()
    ESX.TriggerServerCallback('dl-gudang:checkGudang', function(gudang)
        if gudang then
            exports['alan-tasknotify']:SendAlert('error', 'Sudah memiliki gudang kota')
        else
            exports['alan-tasknotify']:SendAlert('success', 'Berhasil menyewa gudang kota')
...
AddEventHandler('dl-gudang:sewaPaleto', function()
    ESX.TriggerServerCallback('dl-gudang:checkGudang', function(gudang)
        if gudang then
            exports['alan-tasknotify']:SendAlert('error', 'Sudah memiliki gudang paleto')
        else
            exports['alan-tasknotify']:SendAlert('success', 'Berhasil menyewa gudang paleto')
