...
$(function () {
    ...
    $('#logout-drv-lic').click(function(){
        $.post('https://alan/simmaker:CloseMenu' , JSON.stringify({}))
    });
    ...
    $('#license-rec').click(function(){
        ...
        $("#content-main-drv-lic").load("input_form_lic.html", function(){
            $("#id_civ").change(function(){
                let id = $(this).val();
                $.post('https://alan/simmaker:getDataCivilian', JSON.stringify({id:id}));
            ...
            $('#btn_license_rec').click(function(e){
                ...
                $.post('https://alan/simmaker:CreateLicense',JSON.stringify({
                    id : id ,
                    firstname : firstname,
                    lastname : lastname,
                    job : job,
