            ...
            ESX.TriggerServerCallback('esx_ambulancejob:getDeathStatus', function(isDead)
                if isDead == false then
                    ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
                        if skin ~= nil then
                            TriggerEvent("alan-spawn:openMenu")
                            DIMENUCOK = true
                        else
...
RegisterNUICallback("SpawnPlayer", function()
    if klikspawn ~= true then
        exports['alan-tasknotify']:DoHudText('inform', 'Silahkan Pilih salah satu lokasi!')
...
RegisterNUICallback("SpawnLokasiT", function()
    TriggerServerEvent('alan-spawn:LastLocation')
end)
...
RegisterNetEvent('alan-spawn:LastLocationSpawn')
AddEventHandler('alan-spawn:LastLocationSpawn', function(spawn)
...
RegisterNetEvent("alan-spawn:openMenu")
AddEventHandler("alan-spawn:openMenu", function()
    ESX.TriggerServerCallback("alan-spawn:showLastLocation", function(allowed)
        ESX.TriggerServerCallback('alan-spawn:getOwnedProperties', function(properties)
            SendNUIMessage({
                ["Action"] = "OPEN_SPAWNMENU",
                ["ShowLastLocation"] = allowed,
                ["OwnedProperties"] = properties
            })
            ESX.TriggerServerCallback('alan-spawn:getOwnedRumah', function(rumah)
                SendNUIMessage({
                    ["Action"] = "OPEN_SPAWNMENU",
                    ["ShowLastLocation"] = allowed,
                    ["OwnedRumah"] = rumah
...
RegisterCommand('fixspawn', function()
    if DIMENUCOK == true then
        ...
        exports['alan-tasknotify']:DoHudText('error', 'Tidak bisa digunakan kembali!')
    end
