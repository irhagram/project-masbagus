...
-- TODO : EXPORT ox_target ACTION
exports.ox_target:AddBoxZone('emsbajuco', vector3(-1814.05, -358.17, 49.46), 2, 2, {
	name="emsbajuco",
	heading = 140,
	--debugPoly = true,
	minZ = 47.46,
	...
	options = {
		{
			event = "dl-ems:actionmen",
			icon = "far fas fa-tshirt",
			label = "Open Cloakroom",
			job = "ambulance",
		},
		{
			event = "fivem-appearance:browseOutfits",
			icon = "far fas fa-tshirt",
			label = "List Baju(Toko Baju)",
			job = "ambulance",
		},
	},
	distance = 2.0
...
exports.ox_target:AddBoxZone('emsbajuce', vector3(-1815.76, -359.17, 49.46), 2, 2, {
	name="emsbajuce",
	heading = 320,
	--debugPoly = true,
	minZ = 47.46,
...
exports.ox_target:AddBoxZone('emsbajuss', vector3(1824.07, 3671.93, 34.28), 2, 2, {
	name="emsbajuss",
	heading = 120,
	--debugPoly = true,
	minZ = 32.28,
...
exports.ox_target:AddBoxZone('bossems', vector3(-1845.74, -349.03, 84.02), 2, 2, {
	name="bossems",
	heading = 10,
	--debugPoly = true,
	minZ = 83.02,
...
exports.ox_target:AddBoxZone('bossemsss', vector3(1827.82, 3670.11, 34.28), 1, 2, {
	name="bossemsss",
	heading = 25,
	--debugPoly = true,
	minZ = 33.28,
...
exports.ox_target:AddBoxZone('brankas', vector3(-1829.23, -383.87, 49.4), 2.0, 2.0, {
	name="brankas",
	heading=60,
	--debugPoly=true,
	minZ = 47.4,
...
exports.ox_target:AddBoxZone('brankasss', vector3(1829.12, 3674.95, 34.28), 2, 2, {
	name="brankasss",
	heading = 30,
	--debugPoly = true,
	minZ = 32.28,
...
exports.ox_target:AddBoxZone('oplas', vector3(-1876.16, -315.05, 53.77), 5, 5, {
	name = "oplas",
	heading = 45,
	--debugPoly = true,
	minZ = 52.77,
...
--EVENT TARGET--
RegisterNetEvent('dl-ems:actionmen')
AddEventHandler('dl-ems:actionmen', function()
	OpenCloakroomMenu()
end)

RegisterNetEvent('dl-ems:brnks')
AddEventHandler('dl-ems:brnks', function ()
	local ox_inventory = exports.ox_inventory
	ox_inventory:openInventory('stash', 'brankas_ems')
end)

RegisterNetEvent('dl-ems:bossmenu')
AddEventHandler('dl-ems:bossmenu', function(data, menu)
	ESX.UI.Menu.CloseAll()
	TriggerEvent('esx_society:openBossMenu', 'ambulance', function(data, menu)
		menu.close()
...
RegisterNetEvent('dl-job:revive')
...
RegisterNetEvent('dl-job:big')
AddEventHandler('dl-job:big', function()
	local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
	ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
		if quantity > 0 then
			local closestPlayerPed = GetPlayerPed(closestPlayer)
...
AddEventHandler('dl-job:billems', function()
	local input = lib.inputDialog('BILLING EMS', {'ID PLAYER: ', 'JUMLAH: '})

	if input then
		local idplayer = tonumber(input[1])
		local jumlah = input[2]
		TriggerServerEvent('esx_billing:sendBill', idplayer, 'society_ambulance', _U('ambulance'), jumlah)
	end
end)