...
Config.Zones = {
	...
	ls1 = {
		Pos   = {x = 50.000072479248,  y = 6558.5541992188,  z = 31.749855041504},
	...
	ls2 = {
		Pos   = {x = 31.784379959106, y = 6539.666015625, z = 31.749866485596},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = {x = 34.9255027771, y = 6535.9702148438, z = 31.749774932861},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = {x = 38.484069824219,  y = 6532.7260742188, z = 31.749675750732},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls10 = {
		Pos   = {x = 1418.47,  y = 1052.14, z = 113.96},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls11 = {
		Pos   = {x = -1266.94,  y = -3013.21, z = -48.49},
	...
	ls12 = {
		Pos   = {x = -1275.09,  y = -3387.01, z = -13.6},
		Size  = {x = 20.0, y = 20.0, z = 20.0},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {11.9, 13.9, 15.9, 17.9, 19.9}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
	...
	modTransmission = {
		...
		parent = 'upgrades',
		modType = 13,
		price = {12.2, 14.2, 16.2, 18.2, 20.2}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {4.5, 6.5, 8.5, 10.5, 12.5}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {6.7, 8.7, 10.7, 12.7, 14.7}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
	...
	cosmetics = {
		...
		modHeadlightColor	= 'Head Light Color',
