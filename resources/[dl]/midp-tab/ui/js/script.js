$(function () {
    ...
    $(document).on('click', '.noteDelete', function() {
        ...
        $.post('https://midp-tab/noteDelete', JSON.stringify({
            id: id,
    ...
    $('#employee-link').click(function () {
        $.post('https://midp-tab/getEmployees')
    })
    ...
    $(document).on('click', '.deleteBolo', function () {
        var identifier = $(this).data('identifier')
        $.post('https://midp-tab/stopBolo', JSON.stringify({
            identifier: identifier
        }))
    })
    ...
    $(document).on('click', '.boloButton', function () {
        ...
        $.post('https://midp-tab/createBolo', JSON.stringify({
            id: identifier,
            text: text
        }))
    })
    ...
    $(document).on('click', '.noteButton', function() {
        ...
        $.post('https://midp-tab/createNote', JSON.stringify({
            identifier: identifier,
            text: noteText
        }))
    })
    ...
    $(document).on('click', '.uprankButton', function() {
        var identifier = $(this).data('identifier')
        $.post('https://midp-tab/uprank', JSON.stringify({
            identifier: identifier
        }))
    })
    ...
    $(document).on('click', '.derankButton', function() {
        var identifier = $(this).data('identifier')
        $.post('https://midp-tab/derank', JSON.stringify({
            identifier: identifier
        }))
    })
    ...
    $(document).on('click', '.fireButton', function() {
        var identifier = $(this).data('identifier')
        $.post('https://midp-tab/fire', JSON.stringify({
            identifier: identifier
        }))
    })
    ...
    $('#citizenSearchForm').submit(function (e) {
        ...
        if (firstname != "" || lastname != "") {
            $.post('https://midp-tab/searchCitizen', JSON.stringify({
                firstname: firstname,
                lastname: lastname
            }))
            $('#accordion').html('')
    ...
    $('#vehicleSearchForm').submit(function (e) {
        ...
        if (plate != "") {
            $.post('https://midp-tab/searchVehicle', JSON.stringify({
                plate: plate
            }))
        } else {
