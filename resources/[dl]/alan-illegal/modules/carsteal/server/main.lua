...
ESX.RegisterServerCallback('alan-illegal:isAktif',function(source, cb)
  cb(activity, cooldown)
end)

RegisterServerEvent('alan-illegal:aktifYaBund')
AddEventHandler('alan-illegal:aktifYaBund', function(value)
	activity = value
	if value == 1 then
