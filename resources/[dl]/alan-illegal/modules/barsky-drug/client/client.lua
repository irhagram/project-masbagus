    ...
    for k,v in pairs(cohbos) do
      exports["ox_target"]:AddBoxZone("cohbos", vector3(v.x, v.y, v.z), 1.8, 1.5, {
        ...
        options = {
          ...
          {
            event = "alan-context:DutyPedagang",
...
RegisterNetEvent('dl-data:record', function()
  if IsRecording() then 
      exports['alan-tasknotify']:SendAlert('inform', 'Recording sedang berlangsung!', 3500)
  else
      StartRecording(1)
  end
end)
...
RegisterNetEvent('dl-data:stopRecord', function()
  if not IsRecording() then 
      exports['alan-tasknotify']:SendAlert('error', 'Recording tidak berlangsung!', 3500)
  else
...
exports["alan-core"]:registerKeyMapping('Rockstar Editor', '+openrockstar', '', '')