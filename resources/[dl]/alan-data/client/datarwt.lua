        ...
        if playerPed then
            ...
            if currentPos == prevPos then
                if time > 0 then
                    ...
                    TriggerServerEvent("alan-core:keluarKau", "Terdeteksi AFK [2/2]")
                end
            else
...
AddEventHandler('alan-toolkit:onUse', function()
    ...
    if IsPedSittingInAnyVehicle(playerPed) then
        exports['alan-tasknotify']:SendAlert('error', 'Jangan didalam kendaraan!', 10000)
    else
            ...
            exports['mythic_progbar']:Progress({
                ...
                if not cancelled then
                    if r1 == r2 then
                        ...
                        exports['alan-tasknotify']:SendAlert('error', 'Terjadi kesalahan, mesin terbakar!', 10000)
...
RegisterCommand('fixdrop', function()
    ...
    if playerCoords.z < 25 then
        ...
        Wait(5000)
        exports['alan-tasknotify']:SendAlert('inform', 'Kamu berhasil ke teleport ke atas')
	else
		exports['alan-tasknotify']:SendAlert('error', 'Hanya bisa digunakan saat tenggelam!')
    end
end)