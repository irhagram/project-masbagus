			...
			if bankMoney >= vehicle_price then
				MySQL.Async.execute('UPDATE owned_vehicles SET owner = @target WHERE owner = @owner AND plate = @plate', {
					...
					if result2 ~= 0 then	
						...
						TriggerClientEvent('alan-tasknotify:client:SendAlert', -1, { type = 'inform', text = "" ..plate.. ' - MILIK ' ..source_name.. " TERJUAL KE ".. target_name.. '', length = 10000 })
						TriggerClientEvent('alan-tasknotify:Alert', _source, "VEHICLE", "Anda Berhasil Menjual Kendaraan <b>"..model.."</b> Plat: <b>"..plate.."</b>", 10000, 'success')
						TriggerClientEvent('alan-tasknotify:Alert', target, "VEHICLE", "Anda Menerima Kendaraan <b>"..model.."</b> Plat: <b>"..plate.."</b>", 10000, 'success')
				...
				TriggerClientEvent('alan-tasknotify:Alert', _source, "VEHICLE", target_name.." Uangnya Tidak Cukup", 10000, 'error')
				TriggerClientEvent('alan-tasknotify:Alert', target, "VEHICLE", "Anda tidak punya cukup uang untuk membeli: "..source_name.."'s vehicle", 10000, 'error')
			end
		else
			TriggerClientEvent('alan-tasknotify:Alert', _source, "VEHICLE", "Kendaraan: <b>"..plate.."</b> Bukan Milikmu!", 10000, 'error')
			TriggerClientEvent('alan-tasknotify:Alert', target, "VEHICLE", source_name.." Mencoba Menjual Kendaraan Yang Bukan Miliknya", 10000, 'error')
		end
	else
		if result[1] ~= nil then
			MySQL.Async.execute('UPDATE owned_vehicles SET owner = @target WHERE owner = @owner AND plate = @plate', {
				...
				if result2 ~= 0 then
					TriggerClientEvent('alan-tasknotify:Alert', _source, "VEHICLE", "Berhasil Menjual Kendaraan: <b>"..model.."</b> Plat: <b>"..plate.."</b>", 10000, 'success')
					TriggerClientEvent('alan-tasknotify:Alert', target, "VEHICLE", "Mendapat Kendaran: <b>"..model.."</b>Plat: <b>"..plate.."</b>", 10000, 'success')
