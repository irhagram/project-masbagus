...
rootMenuConfig =  {
    ...
    },
    {
        ...
        functionName = "midp-phone:openPhone"
    },
    {
        id = "clotheMenu",
        displayName = "Pakaian",
    ...
    },
    {
        ...
        functionName = "midp-kunci:kunciKendaraan",
        enableMenu = function()
    ...
    },
    {
        ...
        icon = "#engine-general",
        functionName = "midp-kunci:kasihkunci",
        enableMenu = function()
            if IsPedInAnyVehicle(GetPlayerPed(-1), false) and GetPedInVehicleSeat(GetVehiclePedIsIn(PlayerPedId(), false), -1) == PlayerPedId() then
                return true
            else
    ...
    },
    {
        ...
        enableMenu = function()
            return (exports["midp-property"]:getInRumahCOK() and not IsDead)
        end,
...
newSubMenus = {
   ...
   -- EMS
    ...
    --[[['rumah:berikunci'] = {
        title = "Beri Kunci",
        icon = "#lockpick-general",
        functionName = "midp-property:client:giveHouseKey"
    },
    ['rumah:copotkunci'] = {
        title = "Copot Kunci",
        icon = "#lockpick-general",
        functionName = "midp-property:client:removeHouseKey"
    },]]
    ['rumah:kuncirumah'] = {
        title = "Toggle Door",
        icon = "#lockpick-general",
        functionName = "midp-property:client:toggleDoorlock"
    },
    ['rumah:dekorasi'] = {
        title = "Decorate",
        icon = "#property-decoratehouse",
        functionName = "midp-property:client:decorate"
    },
    ['rumah:setstash'] = {
        title = "Set Inv",
