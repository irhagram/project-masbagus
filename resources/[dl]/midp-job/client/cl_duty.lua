...
RegisterNetEvent('midp-context:DutyPolice', function()
...
RegisterNetEvent('midp-context:DutyPedagang', function()
    TriggerEvent('midp-context:sendMenu', {
        {
            id = 1,
...
RegisterNetEvent('midp-context:DutyEms', function()
    TriggerEvent('midp-context:sendMenu', {
        {
            id = 1,
...
RegisterNetEvent('midp-context:DutyTrans', function()
    TriggerEvent('midp-context:sendMenu', {
        {
            id = 1,
            header = "TRANS DAILY",
