...
---                 false otherwise
function ESX.HasItem(items, amount)
    amount = amount or 1
...
function ESX.playAnim(ped, animDict, animName, duration, emoteMoving, playbackRate)
	local movingType = 49
...
function ESX.ShowNotification(text, notifyType, duration)
    exports['midp-tasknotify']:Alert('System', text, notifyType, duration)
end
...
function ESX.ProgressBar(options, completed)
