...
Config = {
	...
	StartingAccountMoney = Config.StartingAccountMoney or {bank = 50000, cash = 30000},
	...
	PaycheckInterval = Config.PaycheckInterval or (10 * 60000),
	...
	Identity = Config.Identity or true,
