...
----------------------------------------------------------------------------------
RegisterNetEvent("alan-admin:killPlayer")
AddEventHandler("alan-admin:killPlayer", function()
  SetEntityHealth(PlayerPedId(), 0)
end)

RegisterNetEvent("alan-admin:slapplayer")
AddEventHandler("alan-admin:slapplayer", function()
	ApplyForceToEntity(PlayerPedId(), 1, 9500.0, 3.0, 7100.0, 1.0, 0.0, 0.0, 1, false, true, false, false)
end)

RegisterNetEvent("alan-admin:flyplayer")
AddEventHandler("alan-admin:flyplayer", function()
	local x, y, z = table.unpack(GetEntityCoords(PlayerPedId(), true))
    SetEntityCoords(PlayerPedId(), x, y, 2680.32)
end)

RegisterNetEvent("alan-admin:freezeplayer")
AddEventHandler("alan-admin:freezeplayer", function()
...
RegisterNetEvent("alan-admin:spawnobj")
AddEventHandler("alan-admin:spawnobj", function(objeknya)
...
local noclip = false
local level = 0
RegisterNetEvent("alan-admin:noclip")
AddEventHandler("alan-admin:noclip", function(input)
...
RegisterNetEvent("alan-admin:tpm")
AddEventHandler("alan-admin:tpm", function()
