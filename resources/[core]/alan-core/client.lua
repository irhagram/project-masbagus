...
AddEventHandler('esx:onPlayerSpawn', function()
	...
	TriggerServerEvent('alan-core:RemoveFromInstance', GetPlayerServerId(PlayerId()))
end)
...
function itemCount(item, metadata)
	if (Config.OxInventory) then
		...
		ESX.TriggerServerCallback('alan-core:itemCount', function(itemCount)
...
AddEventHandler('alan-core:itemCount', function(item, metadata)
...
RegisterNetEvent('alan-core:UseCommand')
AddEventHandler('alan-core:UseCommand', function(cmd)
	ExecuteCommand(cmd)
end)

AddEventHandler('alan-core:SetClothing', function(Type, Drawable, Texture)
