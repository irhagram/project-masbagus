	...
	function(result)
		for k, row in pairs(result) do
			...
			if not alreadyInTable then
				local name = "Tidak ada di kota" -- maybe this should be a locale instead ¯\_(ツ)_/¯
...
ESX.RegisterServerCallback('esx_society:setJob', function(source, cb, identifier, job, grade, type)
	local xPlayer = ESX.GetPlayerFromId(source)
	local isBoss = xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'komjen' or xPlayer.job.grade_name == 'irjen' or xPlayer.job.grade_name == 'brigjen'
...
ESX.RegisterServerCallback('esx_society:setJobSalary', function(source, cb, job, grade, salary)
	...
	if xPlayer.job.name == job or xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'komjen' or xPlayer.job.grade_name == 'irjen' or xPlayer.job.grade_name == 'brigjen' then
