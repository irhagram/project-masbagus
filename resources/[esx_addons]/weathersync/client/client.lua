...
AddEventHandler('esx:playerLoaded', function(player)
    ...
    TriggerServerEvent('weathersync:server:RequestCommands')
end)
...
RegisterNetEvent('weathersync:client:DisableSync', function()
	...
	CreateThread(function()
		while disable do
			SetRainLevel(0.0)
            NetworkOverrideClockTime(15, 30, 0)
...
RegisterNetEvent('weathersync:client:RequestCommands', function(isAllowed)
    if isAllowed then
