AddEventHandler('esx:nui_ready', function()
    CreateFrame('alan-game', 'nui://' .. GetCurrentResourceName() .. '/modules/alan-game/data/html/ui.html')
end)
...
--[[RegisterCommand('thermite', function(source, args)
    ...
    exports["alan-game"]:thermiteminigame(10, 3, 3, 10,
    function() -- success
        print("success")
    end,
    function() -- failure
...
exports('thermiteminigame', function(correctBlocks, incorrectBlocks, timetoShow, timetoLose, success, fail)
    ...
    FocusFrame('alan-game', true, true)
    SendFrameMessage('alan-game', {
        action = "Start",
