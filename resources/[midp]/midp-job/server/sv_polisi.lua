    ...
    if xPlayer and xTarget then
        if xPlayer.job.name == 'police' then
            TriggerEvent('esx_license:checkLicense',xTarget.source,'weapon',function(ret)
                if ret == true then
					TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Orang ini sudah memiliki lisensi senjata!", 2000, 'error')
                else
                    TriggerEvent('esx_license:addLicense', xTarget.source, 'weapon', function()
						TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Berhasil memberikan lisensi senjata", 2000, 'info')
						TriggerClientEvent('midp-tasknotify:Alert', xTarget.source, "Alert", "Mendapatkan lisensi senjata!", 2000, 'info')
                    end)
                end
            end)
        end
    ...
    if xPlayer and xTarget then
        if xPlayer.job.name == 'police' then
            TriggerEvent('esx_license:checkLicense',xTarget.source,'drive',function(ret)
                if ret == true then
					TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Orang ini sudah memiliki Sim A!", 2000, 'error')
                else
                    TriggerEvent('esx_license:addLicense', xTarget.source, 'drive', function()
						TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Berhasil memberikan Sim A", 2000, 'info')
						TriggerClientEvent('midp-tasknotify:Alert', xTarget.source, "Alert", "Mendapatkan Sim A!", 2000, 'info')
                    end)
                end
            end)
        end
    ...
    if xPlayer and xTarget then
        if xPlayer.job.name == 'police' then
            TriggerEvent('esx_license:checkLicense',xTarget.source,'drive_bike',function(ret)
                if ret == true then
					TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Orang ini sudah memiliki Sim B!", 2000, 'error')
                else
                    TriggerEvent('esx_license:addLicense', xTarget.source, 'drive_bike', function()
						TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Berhasil memberikan Sim B", 2000, 'info')
						TriggerClientEvent('midp-tasknotify:Alert', xTarget.source, "Alert", "Mendapatkan Sim B!", 2000, 'info')
                    end)
                end
            end)
        end
    ...
    if xPlayer and xTarget then
        if xPlayer.job.name == 'police' then
            TriggerEvent('esx_license:checkLicense',xTarget.source,'drive_truck',function(ret)
                if ret == true then
					TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Orang ini sudah memiliki Sim C!", 2000, 'error')
                else
                    TriggerEvent('esx_license:addLicense', xTarget.source, 'drive_truck', function()
						TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Berhasil memberikan Sim C", 2000, 'info')
						TriggerClientEvent('midp-tasknotify:Alert', xTarget.source, "Alert", "Mendapatkan Sim C!", 2000, 'info')
                    end)
                end
            end)
        end
            ...
            TriggerEvent('esx_license:checkLicense',xTarget.source,'weapon',function(ret)
                if ret == true then
                    TriggerEvent('esx_license:removeLicense', xTarget.source, 'weapon', function()
						TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Berhasil mencabut lisensi senjata", 2000, 'success')
						TriggerClientEvent('midp-tasknotify:Alert', xTarget.source, "Alert", "Lisensi senjata anda dicabut!", 2000, 'error')
                    end)
                    
                else
					TriggerClientEvent('midp-tasknotify:Alert', _source, "Alert", "Orang ini tidak memiliki lisensi senjata!", 2000, 'error')
                end
            end)
        end
    end
